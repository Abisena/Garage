  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        {/* Login Form */}
        <div className="p-8">
          <h2 className="text-slate-800 mb-6 text-center">Login to Your Branch</h2>
          ...
          <div className="mt-8 p-4 bg-slate-50 rounded-lg border border-slate-200">
            <p className="text-slate-700 mb-3 flex items-center gap-2">
            ...
            <div className="space-y-2 text-sm text-slate-600">
              <div className="flex justify-between">
                ...
                <span className="text-slate-900">admin / admin123</span>
              </div>
              <div className="flex justify-between">
                <span>Jakarta Branch:</span>
                <span className="text-slate-900">jakarta / jakarta123</span>
              </div>
              <div className="flex justify-between">
                <span>Bandung Branch:</span>
                <span className="text-slate-900">bandung / bandung123</span>
              </div>
              <div className="flex justify-between">
                <span>Surabaya Branch:</span>
                <span className="text-slate-900">surabaya / surabaya123</span>
              </div>
            </div>
          </div>
        </div>
