...
interface Registration {
  ...
  fuel?: string;
  assemblyType?: string;
  inspectionStatus?: 'waiting' | 'in-progress' | 'completed';
}

interface InspectionItem {
  item: string;
  status: 'ok' | 'attention' | 'replace';
  notes: string;
}
...
export function Inspection() {
  ...
  const [selectedVehicle, setSelectedVehicle] = useState<Registration | null>(null);
  ...
  const handleVehicleSelect = (registration: Registration) => {
  ...
  const handleInspectionItemChange = (
    category: keyof Pick<InspectionData, 'engine' | 'brakes' | 'tires' | 'electrical' | 'exterior'>,
    index: number,
    field: 'status' | 'notes',
    value: string
  ) => {
  ...
  const handleCompleteInspection = () => {
    ...
    const branchWorkOrders = existingWorkOrders.filter((wo: any) => wo.branch === selectedVehicle.branch);
    ...
    if (savedRegistrations) {
      ...
      const updatedRegistrations = allRegistrations.map((reg: Registration) => {
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h1 className="text-slate-800">Vehicle Inspection & Diagnosis</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <h3 className="text-slate-800 mb-4">Waiting for Inspection</h3>
                    ...
                    <table className="w-full">
                      <thead className="bg-slate-50 border-b border-slate-200">
                        <tr>
                          ...
                          <th className="text-left px-4 py-3 text-slate-700">Vehicle</th>
                          <th className="text-left px-4 py-3 text-slate-700">Plate</th>
                          <th className="text-left px-4 py-3 text-slate-700">Service Type</th>
                          <th className="text-left px-4 py-3 text-slate-700">Time</th>
                          <th className="text-right px-4 py-3 text-slate-700">Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        {waitingRegistrations.map((reg) => (
                          ...
                          >
                            <td className="px-4 py-3">
                              <span className="text-blue-600">{reg.orderId}</span>
                            </td>
                            <td className="px-4 py-3">
                              <div>
                                <p className="text-slate-900">{reg.customerName}</p>
                            ...
                            <td className="px-4 py-3">
                              <span className="text-slate-900">{reg.plateNumber}</span>
                            </td>
                            <td className="px-4 py-3">
                              <span className="text-slate-700">{reg.serviceType}</span>
                            </td>
                            <td className="px-4 py-3">
                              <span className="text-slate-600">{reg.time}</span>
                            </td>
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <h3 className="text-slate-800 mb-4">Inspection Queue</h3>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-amber-50 border border-amber-200 rounded-lg">
                    ...
                    <span className="text-slate-900">{waitingCount}</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <span className="text-slate-900">{inProgressCount}</span>
                  </div>
              ...
              <div className="bg-amber-50 rounded-xl border border-amber-200 p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-amber-900 mb-2">Important</h4>
      ...
      <>
        ...
        <div className="p-8 print:p-0">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Diagnosis Report - A4 Format - REDESIGNED COMPACT */}
            <div id="print-area" className="bg-white rounded-xl border border-slate-200 p-8 print:border-0 print:rounded-none print:p-0">
              ...
              <div className="flex items-center justify-between mb-6 border-b-2 border-slate-800 pb-4">
                ...
                <div className="text-center flex-1">
                  <h1 className="text-slate-800 text-2xl mb-1">VEHICLE INSPECTION & DIAGNOSIS REPORT</h1>
                  <p className="text-slate-600 text-sm">IMOGI Auto Repair Workshop - Branch: {selectedVehicle.branch}</p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6 text-sm">
                ...
                <div className="border border-slate-300 rounded p-3">
                  <h3 className="text-slate-800 mb-2 border-b border-slate-300 pb-1">Order Information</h3>
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      <span className="text-slate-600">Order ID:</span>
                      <span className="text-slate-900">{selectedVehicle.orderId}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-600">Reg ID:</span>
                      <span className="text-slate-900">{selectedVehicle.id}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-600">Date:</span>
                      <span className="text-slate-900">{selectedVehicle.date}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-600">Time:</span>
                      <span className="text-slate-900">{selectedVehicle.time}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="border border-slate-300 rounded p-3">
                  <h3 className="text-slate-800 mb-2 border-b border-slate-300 pb-1">Customer Information</h3>
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      <span className="text-slate-600">Name:</span>
                      <span className="text-slate-900">{selectedVehicle.customerName}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-600">Phone:</span>
                      <span className="text-slate-900">{selectedVehicle.phone}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-600">Email:</span>
                      <span className="text-slate-900 text-xs">{selectedVehicle.email}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="border border-slate-300 rounded p-3">
                  <h3 className="text-slate-800 mb-2 border-b border-slate-300 pb-1">Vehicle Information</h3>
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      <span className="text-slate-600">Brand:</span>
                      <span className="text-slate-900">{selectedVehicle.vehicleBrand} {selectedVehicle.vehicleModel}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-600">Year:</span>
                      <span className="text-slate-900">{selectedVehicle.vehicleYear}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-600">Plate:</span>
                      <span className="text-slate-900">{selectedVehicle.plateNumber}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-600">Type:</span>
                      <span className="text-slate-900">{selectedVehicle.vehicleType}</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="border border-slate-300 rounded p-3">
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      ...
                      <span className="text-slate-900">{selectedVehicle.chassisNumber}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-600">Engine Number:</span>
                      <span className="text-slate-900">{selectedVehicle.engineNumber}</span>
                    </div>
                  </div>
                </div>
                <div className="border border-slate-300 rounded p-3">
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      ...
                      <span className="text-slate-900">{selectedVehicle.serviceType}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-600">Estimated Time:</span>
                      <span className="text-slate-900">{inspectionData.estimatedRepairTime || 'Not specified'}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Customer Complaint */}
              <div className="mb-6">
                <h3 className="text-slate-800 text-sm mb-2 border-b border-slate-300 pb-1">Customer Complaint</h3>
              ...
              <div className="mb-6">
                <h3 className="text-slate-800 text-sm mb-2 border-b border-slate-300 pb-1">Inspection Checklist Results</h3>
                
                <div className="grid grid-cols-2 gap-3">
                  {(['engine', 'brakes', 'tires', 'electrical', 'exterior'] as const).map((category) => (
                    <div key={category} className="border border-slate-300 rounded p-2">
                      <h4 className="text-slate-900 text-sm mb-2 capitalize bg-slate-100 px-2 py-1 rounded">{category}</h4>
                      <div className="space-y-1">
                        {inspectionData[category].map((item, index) => (
                          <div key={index} className="flex items-center justify-between text-xs">
                            <span className="text-slate-700 flex-1">{item.item}</span>
                            <span className={`px-2 py-0.5 rounded ml-2 ${
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  <h3 className="text-slate-800 text-sm mb-2 border-b border-slate-300 pb-1">Diagnosis & Findings</h3>
                ...
                <div>
                  <h3 className="text-slate-800 text-sm mb-2 border-b border-slate-300 pb-1">Recommended Parts</h3>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-slate-800">Performing Inspection</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Vehicle Info Card */}
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <h3 className="text-slate-800 mb-4">Vehicle Information</h3>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-slate-600 text-sm">Vehicle</p>
                  <p className="text-slate-900">{selectedVehicle?.vehicleBrand} {selectedVehicle?.vehicleModel} {selectedVehicle?.vehicleYear}</p>
                </div>
                <div>
                  <p className="text-slate-600 text-sm">Plate Number</p>
                  <p className="text-slate-900">{selectedVehicle?.plateNumber}</p>
                </div>
                <div className="col-span-2">
                  <p className="text-slate-600 text-sm">Customer Complaint</p>
            ...
            {(['engine', 'brakes', 'tires', 'electrical', 'exterior'] as const).map((category) => (
              <div key={category} className="bg-white rounded-xl border border-slate-200 p-6">
                <h3 className="text-slate-800 mb-4 capitalize">{category} Inspection</h3>
                <div className="space-y-3">
                  {inspectionData[category].map((item, index) => (
                    <div key={index} className="flex items-start gap-3 p-3 bg-slate-50 rounded-lg">
                      <div className="flex-1">
                        <p className="text-slate-900 mb-2">{item.item}</p>
            ...
            {/* Diagnosis & Findings */}
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <h3 className="text-slate-800 mb-4">Diagnosis & Findings</h3>
              <textarea
                rows={6}
              ...
              <div className="mt-4">
                <label className="block text-slate-700 mb-2">Recommended Parts & Quantity</label>
                <textarea
                  rows={3}
              ...
              <div className="mt-4">
                <label className="block text-slate-700 mb-2">Estimated Repair Time</label>
                <input
                  type="text"
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <h3 className="text-slate-800 mb-4">Inspection Progress</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
            ...
            <div className="bg-amber-50 rounded-xl border border-amber-200 p-6">
              <div className="flex items-start gap-3">
                <AlertTriangle className="w-6 h-6 text-amber-600 flex-shrink-0" />
                <div>
                  <h4 className="text-amber-900 mb-2">Reminder</h4>
