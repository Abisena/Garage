    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-800 mb-1">Master Spare Parts</h1>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-slate-900 text-2xl font-bold">{spareParts.length}</p>
              </div>
        ...
        {(isAddingNew || editingId) && (
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            <h3 className="text-lg font-semibold text-slate-800 mb-4">
              {isAddingNew ? 'Add New Part' : 'Edit Part'}
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">
                  Compatible Models * (Select multiple)
                </label>
                <select
                  multiple
                ...
                <p className="text-xs text-slate-500 mt-1">Hold Ctrl/Cmd to select multiple models</p>
              </div>

              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Unit Price (Rp) *</label>
                <input
                  type="number"
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  <th className="text-left px-6 py-4 text-sm font-semibold text-slate-700">Part Name</th>
                  <th className="text-left px-6 py-4 text-sm font-semibold text-slate-700">Part Number</th>
                  <th className="text-left px-6 py-4 text-sm font-semibold text-slate-700">Category</th>
                  <th className="text-left px-6 py-4 text-sm font-semibold text-slate-700">Compatible Models</th>
                  <th className="text-right px-6 py-4 text-sm font-semibold text-slate-700">Unit Price</th>
                  <th className="text-center px-6 py-4 text-sm font-semibold text-slate-700">Stock</th>
                  <th className="text-center px-6 py-4 text-sm font-semibold text-slate-700">Min Stock</th>
              ...
              <tbody>
                {filteredParts.map((part) => (
                  <tr key={part.id} className="border-b border-slate-100 hover:bg-slate-50">
                    <td className="px-6 py-4 text-sm text-slate-900">{part.partName}</td>
                    <td className="px-6 py-4 text-sm text-slate-700">{part.partNumber}</td>
                    ...
                    <td className="px-6 py-4 text-sm text-right text-slate-900">{formatCurrency(part.unitPrice)}</td>
                    ...
                    <td className="px-6 py-4 text-sm text-center text-slate-700">{part.minStock}</td>
                    <td className="px-6 py-4">
