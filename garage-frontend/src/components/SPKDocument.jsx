...
export function SPKDocument({ workOrder, spareParts }) {
      ...
      <div id="spk-print-area" className="print:p-0 text-sm" style={{ fontFamily: 'Arial, sans-serif' }}>
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <h2 className="text-base mb-0" style={{ color: '#5b7c99', fontWeight: '600' }}>IMOGI Workshop</h2>
            <p className="text-sm text-slate-600 mb-0.5" style={{ color: '#5b7c99' }}>Multi Branch Car Repair Service</p>
            <p className="text-xs text-slate-600" style={{ color: '#5b7c99' }}>Email: imogiofficial@cao-group.co.id | Telp: (021) 1234-5678</p>
          </div>
