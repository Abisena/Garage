...
// "Customer", etc.). Unlike GarageVehicleQuickEntryForm above, there's no
// frappe._from_link carve-out here - that check exists elsewhere
// specifically to keep a Link field's own in-context "+ Create New" on
// the quick dialog, which is exactly the behaviour this override
// deliberately does NOT want for Customer.
