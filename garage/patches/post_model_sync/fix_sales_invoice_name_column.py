"""Ensure Garage Sales Invoice name column supports branch-prefixed naming."""
...
def execute() -> None:
    """Alter the Garage Sales Invoice name column to VARCHAR when needed."""
    ...
    if not db_name:
        return
    table_name = "tabGarage Sales Invoice"
