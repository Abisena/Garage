"""Ensure Garage Payment Entry name column supports branch-prefixed naming."""
...
def execute() -> None:
    """Alter the Garage Payment Entry name column to VARCHAR when needed."""
    ...
    table_name = "tabGarage Payment Entry"
