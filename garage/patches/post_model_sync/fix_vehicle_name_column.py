"""Ensure Garage Vehicle name column supports branch-prefixed naming."""
...
def execute() -> None:
    """Alter the Garage Vehicle name column to VARCHAR when needed."""
