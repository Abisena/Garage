...
app_include_js = ["/assets/garage/js/route_aliases.js?v=1", "/assets/garage/js/garage_theme.js?v=85"]
    ...
    },
    {
        ...
        "filters": [[
            ...
            [
                ...
                "Attendance-main-field_order",
                "Attendance-details_section-hidden",
                "Attendance-column_break_18-hidden",
            ],
        ]],
    },
    {
...
doc_events = {
    ...
    "Item": {
        "before_insert": "garage.utils.item_hooks.generate_item_code_from_prefix",
